...
namespace eFurnitureProject.API.Controllers
{
    public class VoucherController : BaseController
    {
       ...
       [Authorize(Roles = AppRole.Admin)]
        ...
        [HttpGet]
        public async Task<ApiResponse<Pagination<VoucherViewDTO>>> Filter(int pageIndex, int pageSize, DateTime date) => await _voucherService.Fileter(pageIndex, pageSize, date);
    }
}
