...
namespace eFurnitureProject.API.Validator.UserValidator
{
    public class CreateUserValidation : AbstractValidator<CreateUserDTO>
    {
        public CreateUserValidation()
        {
            ...
            RuleFor(x => x.Role).NotEmpty().WithMessage("Role must not be empty.")
            .GreaterThan(0).WithMessage("Role must be greater than 0.")
            .LessThan(4).WithMessage("Role must be less than 4.");
